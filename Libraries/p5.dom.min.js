...
!function(t, e) {
    ...
    function l(t) {
        var e = document;
        return "string" == typeof t && "#" === t[0] ? (t = t.slice(1),
        e = document.getElementById(t) || document) : t instanceof d.Element ? e = t.elt : t instanceof HTMLElement && (e = t),
        e
    }
    function c(t, e, i) {
        (e._userNode ? e._userNode : document.body).appendChild(t);
        var n = i ? new d.MediaElement(t,e) : new d.Element(t,e);
        return e._elements.push(n),
        n
    }
    d.prototype.select = function(t, e) {
        ...
        var i = null
          , n = l(e);
        return (i = "." === t[0] ? (t = t.slice(1),
        (i = n.getElementsByClassName(t)).length ? i[0] : null) : "#" === t[0] ? (t = t.slice(1),
        n.getElementById(t)) : (i = n.getElementsByTagName(t)).length ? i[0] : null) ? this._wrapElement(i) : null
    }
    ,
    d.prototype.selectAll = function(t, e) {
        d._validateParameters("selectAll", arguments);
        var i, n = [], r = l(e);
        if (i = "." === t[0] ? (t = t.slice(1),
        r.getElementsByClassName(t)) : r.getElementsByTagName(t))
    ...
    d.prototype._wrapElement = function(t) {
        ...
        if ("INPUT" !== t.tagName || "checkbox" !== t.type)
            return "VIDEO" === t.tagName || "AUDIO" === t.tagName ? new d.MediaElement(t,this) : "SELECT" === t.tagName ? this.createSelect(new d.Element(t,this)) : 0 < e.length && e.every(function(t) {
    ...
    d.Element.prototype.changed = function(t) {
        return d.Element._adjustListener("change", t, this),
        this
    }
    ,
    d.Element.prototype.input = function(t) {
        return d.Element._adjustListener("input", t, this),
        this
    }
    ;
    function i(t, e, i, n) {
        ...
        if (void 0 !== n) {
            var l = function() {
                n(),
                r.removeEventListener("canplaythrough", l)
            };
        ...
        r.addEventListener("loadedmetadata", function() {
            ...
            a.presetPlaybackRate && (a.elt.playbackRate = a.presetPlaybackRate,
            delete a.presetPlaybackRate),
            a.loadedmetadata = !0
        }),
        a
    }
    ...
    d.prototype.createImg = function() {
        ...
        t.onload = function() {
            ...
            1 < i.length && "function" == typeof i[1] ? (e.fn = i[1],
            e.fn()) : 1 < i.length && "function" == typeof i[2] && (e.fn = i[2],
            e.fn())
        }
        ,
        e = c(t, this)
    ...
    d.prototype.createSelect = function() {
        ...
        var e = arguments[0];
        return "object" == typeof e && "SELECT" === e.elt.nodeName ? (t = e,
        o = this.elt = e.elt) : (o = document.createElement("select"),
        ...
        t.option = function(t, e) {
            ...
            if (void 0 !== i)
                !1 === e ? this.elt.remove(i) : this.elt[i].innerHTML === this.elt[i].value ? this.elt[i].innerHTML = this.elt[i].value = e : this.elt[i].value = e;
            else {
    ...
    d.prototype.createRadio = function(t) {
        ...
        var r, n, e = document.querySelectorAll("input[type=radio]"), o = 0;
        if (1 < e.length)
            ...
            1 === e.length && (o = 1);
        "object" == typeof t ? (n = t,
        r = this.elt = t.elt) : (r = document.createElement("div"),
        n = c(r, this)),
    ...
    d.prototype.createColorPicker = function(t) {
        ...
        return i.type = "color",
        t ? t instanceof d.Color ? i.value = t.toString("#rrggbb") : (d.prototype._colorMode = "rgb",
        d.prototype._colorMaxes = {
            rgb: [255, 255, 255, 255],
            hsb: [360, 100, 100, 1],
            hsl: [360, 100, 100, 1]
        },
        i.value = d.prototype.color(t).toString("#rrggbb")) : i.value = "#000000",
        (e = c(i, this)).color = function() {
            return t.mode && (d.prototype._colorMode = t.mode),
    ...
    d.prototype.createFileInput = function(r, t) {
        if (d._validateParameters("createFileInput", arguments),
    ...
    d.prototype.createVideo = function(t, e) {
        return d._validateParameters("createVideo", arguments),
        i(this, "video", t, e)
    }
    ,
    d.prototype.createAudio = function(t, e) {
        return d._validateParameters("createAudio", arguments),
        i(this, "audio", t, e)
    }
    ,
    ...
    d.prototype.createCapture = function() {
        ...
        for (var t, i, e = !0, n = !0, r = 0; r < arguments.length; r++)
            arguments[r] === d.prototype.VIDEO ? n = !1 : arguments[r] === d.prototype.AUDIO ? e = !1 : "object" == typeof arguments[r] ? t = arguments[r] : "function" == typeof arguments[r] && (i = arguments[r]);
        ...
        var s = c(o, this, !0);
        return s.loadedmetadata = !1,
        o.addEventListener("loadedmetadata", function() {
            o.play(),
            o.width ? (s.width = o.videoWidth = o.width,
            s.height = o.videoHeight = o.height) : (s.width = s.elt.width = o.videoWidth,
            s.height = s.elt.height = o.videoHeight),
            s.loadedmetadata = !0
        }),
        s
    }
    ...
    d.Element.prototype.addClass = function(t) {
        return this.elt.className ? this.hasClass(t) || (this.elt.className = this.elt.className + " " + t) : this.elt.className = t,
        this
    }
    ,
    d.Element.prototype.removeClass = function(t) {
        return this.elt.classList.remove(t),
        this
    }
    ,
    ...
    d.Element.prototype.toggleClass = function(t) {
        return this.elt.classList.contains(t) ? this.elt.classList.remove(t) : this.elt.classList.add(t),
        this
    }
    ,
    d.Element.prototype.child = function(t) {
        return void 0 === t ? this.elt.childNodes : ("string" == typeof t ? ("#" === t[0] && (t = t.substring(1)),
        t = document.getElementById(t)) : t instanceof d.Element && (t = t.elt),
    ...
    d.Element.prototype.center = function(t) {
        ...
        var o = Math.abs(this.parent().offsetWidth - this.elt.offsetWidth)
          ...
          , l = r.y
          , a = r.x;
        return "both" === t || void 0 === t ? this.position(o / 2, s / 2) : "horizontal" === t ? this.position(o / 2, l) : "vertical" === t && this.position(a, s / 2),
    ...
    d.Element.prototype.style = function(t, e) {
        if (e instanceof d.Color && (e = "rgba(" + e.levels[0] + "," + e.levels[1] + "," + e.levels[2] + "," + e.levels[3] / 255 + ")"),
        void 0 === e) {
            if (-1 === t.indexOf(":"))
                return window.getComputedStyle(this.elt).getPropertyValue(t);
            for (var i = t.split(";"), n = 0; n < i.length; n++) {
                var r = i[n].split(":");
                r[0] && r[1] && (this.elt.style[r[0].trim()] = r[1].trim())
            }
        } else if (this.elt.style[t] = e,
        "width" === t || "height" === t || "left" === t || "top" === t) {
            var o = e.replace(/\D+/g, "");
    ...
    d.Element.prototype.attribute = function(t, e) {
        if (null == this.elt.firstChild || "checkbox" !== this.elt.firstChild.type && "radio" !== this.elt.firstChild.type)
            ...
            this);
        if (void 0 === e)
            return this.elt.firstChild.getAttribute(t);
    ...
    d.Element.prototype.value = function() {
        return 0 < arguments.length ? (this.elt.value = arguments[0],
    ...
    d.Element.prototype.size = function(t, e) {
        ...
        var i = t
          ...
          , r = d.prototype.AUTO;
        if (i !== r || n !== r) {
            if (i === r ? i = e * this.width / this.height : n === r && (n = t * this.height / this.width),
            this.elt instanceof HTMLCanvasElement) {
                var o, s = {}, l = this.elt.getContext("2d");
                for (o in l)
                    s[o] = l[o];
            ...
            this._pInst && this._pInst._curElement && this._pInst._curElement.elt === this.elt && (this._pInst._setProperty("width", this.elt.offsetWidth),
    ...
    d.MediaElement = function(n, t) {
        ...
        Object.defineProperty(r, "src", {
            ...
            set: function(t) {
                for (var e = 0; e < r.elt.children.length; e++)
                    r.elt.removeChild(r.elt.children[e]);
    ...
    d.MediaElement.prototype.play = function() {
        ...
        (t = (1 < this.elt.readyState || this.elt.load(),
        this.elt.play())) && t.catch && t.catch(function(t) {
    ...
    d.MediaElement.prototype.time = function(t) {
        return void 0 === t ? this.elt.currentTime : (this.elt.currentTime = t,
        this)
    }
    ,
    ...
    d.MediaElement.prototype.loadPixels = function() {
        ...
        this.loadedmetadata) {
            this.canvas.width !== this.elt.width && (this.canvas.width = this.elt.width,
            this.canvas.height = this.elt.height,
            this.width = this.canvas.width,
            this.height = this.canvas.height,
            this._pixelsDirty = !0);
            var t = this.elt.currentTime;
            (this._pixelsDirty || this._pixelsTime !== t) && (this._pixelsTime = t,
            this._pixelsDirty = !0,
        ...
        return this.setModified(!0),
        this
    }
    ,
    d.MediaElement.prototype.updatePixels = function(t, e, i, n) {
        return this.loadedmetadata && (this._ensureCanvas(),
        d.Renderer2D.prototype.updatePixels.call(this, t, e, i, n)),
        this.setModified(!0),
        this
    }
    ,
    d.MediaElement.prototype.get = function() {
        return this._ensureCanvas(),
        d.Renderer2D.prototype.get.apply(this, arguments)
    }
    ,
    ...
    d.MediaElement.prototype.set = function(t, e, i) {
        this.loadedmetadata && (this._ensureCanvas(),
        d.Renderer2D.prototype.set.call(this, t, e, i),
        this.setModified(!0))
    }
    ,
    ...
    d.MediaElement.prototype.mask = function() {
        this.loadPixels(),
        this.setModified(!0),
        d.Image.prototype.mask.apply(this, arguments)
    }
    ,
    ...
    d.MediaElement.prototype.connect = function(t) {
        ...
        this.audioSourceNode || (this.audioSourceNode = e.createMediaElementSource(this.elt),
    ...
    d.MediaElement.prototype.removeCue = function(t) {
        for (var e = 0; e < this._cues.length; e++)
            this._cues[e].id === t && (console.log(t),
    ...
    d.File._load = function(t, e) {
        if (/^text\//.test(t.type))
            d.File._createLoader(t, e).readAsText(t);
        else if (/^(video|audio)\//.test(t.type)) {
            var i = new d.File(t);
            i.data = URL.createObjectURL(t),
            e(i)
        } else
            d.File._createLoader(t, e).readAsDataURL(t)
    }
});
